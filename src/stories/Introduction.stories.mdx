...
[Theme colors](/docs/atoms-colors--page) are also offered as hex codes:
...
<Source
  ...
  code={`
body {
  background-color: rgb(var(--backg-primary) / 1); /* also available as \`bg-backg-primary\` class */
  color: rgb(var(--text-primary) / 1); /* also available as \`text-primary\` class */
}
`}
/>
...
----
## Contributing
- [CONTRIBUTING.md](https://github.com/caripizza/ui/blob/main/CONTRIBUTING.md)

## Resources
- [README on GitHub](https://github.com/caripizza/ui/blob/main/README.md)
